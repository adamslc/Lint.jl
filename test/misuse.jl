...
@test_broken msgs[1].code == :W447
@test_broken occursin("it should be of type Type", msgs[1].message)
@test_broken msgs[2].code == :W447
@test_broken occursin("it should be of type Type", msgs[2].message)
